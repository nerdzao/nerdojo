...
def matrix_of_5(array):
    ...
    if prod_diag2 > max_answer: max_answer = prod_diag2
...
def get_max_5_value_in_any_array(matrix):
    ...
    if y > 5 and x > 5:
        ...
        return 0 #Should be an invalid input, since the matrix must be at least 5x5
    else:
        return matrix_of_5(matrix)


# Testing solution for case 5x5
for i in range(5):
